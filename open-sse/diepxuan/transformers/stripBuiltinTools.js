...
//
// Wired from `translator/index.js` AFTER `prepareClaudeRequest`.
// Strips nameless/unsupported tools before dispatch to MiniMax gateway.
...
const TARGETS = {
  "minimax-cn": new Set(["MiniMax-M3", "MiniMax-M2.7"]),
