...
<div align="center">
  ...
  **Nhà cung cấp AI Miễn cho OpenClaw.**
  ...
  [![License](https://img.shields.io/npm/l/9router.svg)](https://github.com/diepxuan/9router/blob/main/LICENSE)
...
| `NEXT_PUBLIC_BASE_URL` | `http://localhost:20128` | URL cơ sở tương thích ngược/công khai (ưu tiên `BASE_URL` cho runtime máy chủ) |
...
- **Fork repository**: `diepxuan/9router`
...
[![Contributors](https://contrib.rocks/image?repo=diepxuan/9router&max=100&columns=20&anon=1)](https://github.com/diepxuan/9router/graphs/contributors)

---

## 📊 Star Chart

[![ Chart](https://starchart.cc/diepxuan/9router.svg?variant=adaptive)](https://starchart.cc/diepxuan/9router)
...
Xem [Pull Requests](https://github.com/diepxuan/9router/pulls) để biết hướng dẫn chi tiết.
